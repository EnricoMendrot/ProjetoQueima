...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("database", "0015_remove_funcionario_empresa"),  # <- troque para a sua última migration real
    ]
    ...
    operations = [
        ...
        migrations.RenameField("equipamento", "Status_Operacional", "status_operacional"),
        ...
        migrations.RenameField("ocorrenciaqueima", "ClassificacaoQueima", "classificacao_queima"),
        migrations.RenameField("ocorrenciaqueima", "statuscomunicacao", "status_comunicacao"),
