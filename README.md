...
Abaixo estão indicadas as seções onde serão detalhados os endpoints e métodos de requisição utilizados no projeto:

### **Métodos GET**

*(Descrição dos endpoints GET será inserida aqui)*

### **Métodos POST**

*(Descrição dos endpoints POST será inserida aqui)*
...
- **Enrico Mendrot:** Supervisor do projeto, desenvolvedor Back-End e responsável pelo banco de dados  
- **Isabella Santos:** Desenvolvedora do protótipo (Figma) e responsável pelo Front-End  
- **Flávio Fernandes:** Desenvolvedor Front-End e colaborador na criação do banco de dados  
- **Renan Machado:** Desenvolvedor Full Stack (Back-End e Front-End)  
- **Carlos Henrique:** Responsável pela documentação do projeto  
